...
> ℹ️ **Status:** AKS Bicep, Kubernetes manifests, monitoring alert, runbook, workflows, and documentation are all included. Bootstrap steps (Azure provisioning and container image build/publish) are manual — see [Setup](#setup) below.
